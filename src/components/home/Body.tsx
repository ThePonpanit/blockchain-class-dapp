...
const Body: FC = () => {
  ...
  return (
    <Container size="xl" className="flex flex-col gap-2">
      <div className="relative flex h-40 flex-col items-center justify-center gap-3 rounded-lg bg-sky-400">
        ...
        <div className="flex items-center gap-2 text-sm  text-black">
          ...
          <span className="italic text-grey">Ponpanit Yakhampor 600612106</span>
        </div>
      </div>
